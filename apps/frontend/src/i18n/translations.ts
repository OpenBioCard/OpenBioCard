export const translations = {
  'zh-Hant': {
    ...
    passwordPlaceholder: '請輸入密碼（至少8個字符）',
    confirm: '確認並初始化',
    validating: '驗證中...',
    initializing: '初始化中...',
    success: '初始化成功！',
    ...
    usernamePasswordMinLength: '用戶名至少3個字符，密碼至少8個字符',
    systemStatus: '系統狀態',
    refresh: '刷新',
    refreshing: '刷新中...',
    systemInfo: '系統信息',
  ...
  'zh-CN': {
    ...
    usernamePasswordMinLength: '用户名至少3个字符，密码至少8个字符',
    systemStatus: '系统状态',
    refresh: '刷新',
    refreshing: '刷新中...',
    systemInfo: '系统信息',
  ...
  'en': {
    ...
    usernamePasswordMinLength: 'Username min 3 chars, password min 8 chars',
  ...
  'ja': {
    ...
    usernamePasswordMinLength: 'ユーザー名は3文字以上、パスワードは8文字以上',
    systemStatus: 'システム状態',
    refresh: '更新',
    refreshing: '更新中...',
    systemInfo: 'システム情報',
